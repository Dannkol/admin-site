...
class Modellocations extends connect
{
    ...
    {
        try {
            $query = 'INSERT INTO locations(name_location) VALUES(:name_location)';
            $res = self::getConnection()->prepare($query);
            $res->bindParam(":name_location", $data['name_location']);
    ...
    {
        try {
            $queryGetAll = 'SELECT id , name_location FROM locations';
    ...
    {
        try {
            $queryGetid = 'SELECT id , name_location FROM locations';
    ...
    public static function update($id, $data)
    {
        try {
            ...
            if ($data['name_location'] !== null) {
                $query .= ' name_location = :name_location,';
                $params[':name_location'] = $data['name_location'];
            }
