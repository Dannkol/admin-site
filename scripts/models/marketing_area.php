...
class ModelaMarketing_area extends connect
{
    ...
    {
        try {
            $query = 'INSERT INTO marketing_area(id_area,id_staff,id_position,id_journeys) VALUES(:area,:staff,:position,:journeys)';
    ...
    {
        try {
            $queryGetAll = 'SELECT t1.id AS "identificador", t2.name_area AS "area", t3.first_name AS "staff_first_name", t4.name_position AS "position", t5.name_journey AS "journeys" FROM marketing_area AS t1';
    ...
    {
        try {
            $queryGetid = 'SELECT t1.id AS "identificador", t2.name_area AS "area", t3.first_name AS "staff_first_name", t4.name_position AS "position", t5.name_journey AS "journeys" FROM marketing_area AS t1';
    ...
    {
        try {
            $query = 'DELETE FROM marketing_area WHERE id = :id';
            $res = self::getConnection()->prepare($query);
            $res->bindParam(':id', $id);
            $res->execute();
    ...
    {
        try {
            $query = 'UPDATE marketing_area SET';
            $params = [];
