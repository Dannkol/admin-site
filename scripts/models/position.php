...
class ModelPosition extends connect
{
    ...
    {
        try {
            $query = 'INSERT INTO position(name_position , arl) VALUES(:name_position, :arl)';
            $res = self::getConnection()->prepare($query);
            $res->bindParam(":name_position", $data['name_position']);
            $res->bindParam(":arl", $data['arl']);
    ...
    {
        try {
            $queryGetAll = 'SELECT id , name_position, arl FROM position';
    ...
    {
        try {
            $queryGetid = 'SELECT id , name_position, arl FROM position';
    ...
    public static function update($id, $data)
    {
        try {
            ...
            if ($data['name_position'] !== null) {
                $query .= ' name_position = :name_position,';
                $params[':name_position'] = $data['name_position'];
            }
            if ($data['arl'] !== null) {
                $query .= ' arl = :arl,';
                $params[':arl'] = $data['arl'];
