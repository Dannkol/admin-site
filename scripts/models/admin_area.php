...
class ModelAdmin_area extends connect
{
    ...
    {
        try {
            $query = 'INSERT INTO admin_area(id_area,id_staff,id_position,id_journeys) VALUES(:area,:staff,:position,:journeys)';
    ...
    {
        try {
            $queryGetAll = 'SELECT t1.id AS "identificador", t2.name_area AS "area", t3.first_name AS "staff_first_name", t4.name_position AS "position", t5.name_journey AS "journeys" FROM admin_area AS t1';
    ...
    {
        try {
            $queryGetid = 'SELECT t1.id AS "identificador", t2.name_area AS "area", t3.first_name AS "staff_first_name", t4.name_position AS "position", t5.name_journey AS "journeys" FROM admin_area AS t1';
    ...
    {
        try {
            $query = 'DELETE FROM admin_area WHERE id = :id';
            $res = self::getConnection()->prepare($query);
            $res->bindParam(':id', $id);
            $res->execute();
