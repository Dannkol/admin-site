    ...
    componet() {
        this.name = class extends HTMLElement {
            ...
            edit(item) {
                ...
                row.querySelectorAll('td')[0].innerHTML = `<input type="text" value="" class="form-control" placeholder="${row.querySelectorAll('td')[0].textContent}"></input>` 
                row.querySelectorAll('td')[1].innerHTML = `<input type="text" value="" class="form-control" placeholder="${row.querySelectorAll('td')[1].textContent}"></input>` 
